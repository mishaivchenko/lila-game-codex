  ...
  return (
    <main className="lila-page-shell">
      <div className="lila-canva-frame min-h-0 flex-1">
        ...
        <div
          className="grid min-h-0 flex-1 gap-4 pt-4 grid-rows-[auto_minmax(0,1fr)] xl:grid-cols-[minmax(0,0.98fr)_360px] xl:grid-rows-1"
          data-testid="single-start-layout"
        >
          <section className="relative flex min-h-0 flex-col items-center justify-center px-2 text-center sm:px-4">
            <BrandLogo
              alt="SoulVio Ліла"
            ...
            <div className="w-full max-w-[720px]">
              ...
              <div className="mt-6 space-y-3">
                <button
                  ...
                  className="lila-canva-action w-full px-5 py-4 text-center"
                >
                  <p className="text-[1.28rem] font-black uppercase tracking-[-0.04em] text-[var(--lila-text-primary)]">
                    Почати нову гру
                  </p>
                  <p className="mt-2 text-sm leading-5 text-[var(--lila-text-muted)]">Новий запит, новий вхід у гру.</p>
                </button>
                ...
                <button
                  ...
                  className="lila-canva-action w-full px-5 py-4 text-center disabled:cursor-not-allowed disabled:opacity-55"
                >
                  <p className="text-[1.28rem] font-black uppercase tracking-[-0.04em] text-[var(--lila-text-primary)]">
                    Продовжити розмову із собою
                  </p>
                  <p className="mt-2 text-sm leading-5 text-[var(--lila-text-muted)]">
                    {activeSession
                      ? `Продовжити з клітини ${activeSession.currentCell}.`
                      : 'Коли зʼявиться активна сесія, вона відкриється тут.'}
                  </p>
                </button>
              </div>
