...
- Last updated: `2026-02-25T17:59:11Z`
- Generated by: `Codex`
...
- Double-tap zoom sharpness fix:
  - added DPR/zoom-aware board image quality selector (`resolveBoardImageRenderScale`);
  - board background now renders oversampled while camera zoom is active, reducing pixel-stretch blur on mobile double-tap zoom;
  - camera transform switched to 2D translate/scale for more stable raster quality in mobile WebView compositors.
...
| Source files | 168 |
| Source LOC | 10976 |
| Frontend files / LOC | 156 / 10515 |
| Backend files / LOC | 12 / 461 |
| Test files / LOC | 32 / 1708 |
| Test file ratio vs source | 19.0% |
| Source files with direct test match | 28.8% |
...
- `frontend/src/components/lila/LilaBoardCanvas.tsx` (medium): camera follow, drag pan, token/path sync and transformed pointer mapping remain, but step sequencing now delegates to MovementEngine.
