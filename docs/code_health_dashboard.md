...
- Last updated: `2026-02-27T01:54:00Z`
- Generated by: `Codex`
...
- TMA auth resilience:
  ...
  - frontend auth errors now surface backend messages instead of collapsing all failures into the same generic “Telegram auth failed” text, which makes production diagnosis possible.
