...
- Last updated: `2026-02-26T19:02:18Z`
- Generated by: `Codex`
...
- Telegram Mini App polish pass:
  ...
  - improved TMA shell behavior with route-aware `BackButton`, optional `MainButton` invite action, and `themeChanged` listener sync;
  - added safe-area/overscroll shell hardening for iOS/Android (`100dvh`, `safe-area-inset` paddings, white-flash mitigation);
  - added lightweight invite flow (`shareURL` with Telegram deep-link fallback) and regression tests for haptics/share adapters.
...
| Source files | 169 |
| Source LOC | 13436 |
| Frontend files / LOC | 154 / 12684 |
| Backend files / LOC | 15 / 752 |
| Test files / LOC | 38 / 2501 |
| Test file ratio vs source | 22.5% |
| Source files with direct test match | 30.3% |
